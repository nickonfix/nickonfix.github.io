...
ninja.data = [{
    ...
    handler: () => {
      ...
      handler: () => {
          ...
          description: "The primary approach is to create a Markov Random Field whose partition function is the permanent of a square matrix. Then use Belief Propagation to compute Bethe Free Energy which approximates the permanent. We then try to generalize the algorithm to compute permanent of rectangular matrices. This internship at CMI was a part of my bachelor’s thesis.",
          section: "Projects",handler: () => {
